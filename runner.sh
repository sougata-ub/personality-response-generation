...
#ONLY FOR RESPONSE GENERATION, WITHOUT TRAINING
#for i in $(seq "$1" "$2")
#do
#  echo "Running experiment_num: $i"
...
# FOR EVALUATING PERSONALITY OF THE GENERATED RESPONSES
#for fname in "$1"/*.pkl
#do
...
# FOR EVALUATING INTENT OF THE GENERATED RESPONSES
# for fname in "$1"/*.pkl
# do
#   echo "Running test for $fname"
